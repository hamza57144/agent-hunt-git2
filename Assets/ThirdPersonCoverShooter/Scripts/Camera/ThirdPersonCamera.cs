    ...
    public class ThirdPersonCamera : BaseCamera
    {
        ...
        public void UpdatePosition()
        {
            ...
            if (gun != null && gun.Scope != null && (Target.IsScoping || (controller != null && controller.IsScoping)))
            {
                ...
                _wasScoped = true;
                _obstacleFix = Util.Lerp(_obstacleFix, Vector3.zero, 1);
            }
            else
            {
                _wasScoped = false;
        ...
        public override void UpdateForCharacterMotor()
        {
           ...
           UpdatePosition();
            ...
            else if (controller != null && controller.IsZooming || !once)
            {
                ...
                if (couldCornerAim)
                {
                    ...
                    /*else if(Target.IsInTallCover && Target.HasScope())
                     {
                        _stateName = "TallCornerZoom";
                        States.TallCornerZoom.Offset= States.TallCornerZoom.ScopeOffset *//*new Vector3(0.75f, -0.2f, 4)*//*;
                        state = States.TallCornerZoom;
                    }*/
                    else
                    {
            ...
            if (isScoped || _wasScoped)
            {
                ...
                //_camera.fieldOfView = Util.Lerp(_camera.fieldOfView, fov, lerp * 1.5f);
            ...
            if(!ThirdPersonInput.zoomIn && once)
             _camera.fieldOfView = Util.Lerp(_camera.fieldOfView, fov, 2f);
            else
            {
                _stateName = "TallCornerZoom";
                state = States.TallCornerZoom;
        ...
        IEnumerator SmoothZoom()
        {
           ...
           once = false;
            ...
            _camera.fieldOfView = Util.Lerp(_camera.fieldOfView, myFov, 3f);
        }
        IEnumerator ZoomOut()
        {
            Vector3 camPos = _camera.gameObject.transform.position;
