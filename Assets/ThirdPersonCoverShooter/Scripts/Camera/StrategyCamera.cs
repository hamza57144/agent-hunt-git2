    ...
    public class StrategyCamera : BaseCamera
    {
        ...
        protected override void Update()
        {
            ...
            else
            {
                ...
                if (ControlFreak2.CF2Input.GetKey(KeyCode.W)) forwardTarget = 1;
                if (ControlFreak2.CF2Input.GetKey(KeyCode.S)) forwardTarget = -1;
                if (ControlFreak2.CF2Input.GetKey(KeyCode.D)) rightTarget = 1;
                if (ControlFreak2.CF2Input.GetKey(KeyCode.A)) rightTarget = -1;
            ...
            _heightOffset = Mathf.Clamp(transform.position.y + _heightOffset - ControlFreak2.CF2Input.mouseScrollDelta.y * HeightSpeed * 0.5f, MinHeight, MaxHeight) - transform.position.y;
