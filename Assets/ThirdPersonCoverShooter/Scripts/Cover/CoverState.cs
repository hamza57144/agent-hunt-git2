...
namespace CoverShooter
{
    ...
    public struct CoverState
    {
        ...
        public bool IsStandingLeft
        {
            get
            {
                return /*Mathf.DeltaAngle(MovementAngle, ForwardAngle) > 0*/Main.OpenLeft && !Main.OpenRight;
            }
        }
        ...
        public bool IsStandingRight
        {
            get
            {
                return /*Mathf.DeltaAngle(MovementAngle, ForwardAngle) < 0*/ Main.OpenRight && !Main.OpenLeft;
            }
        }
