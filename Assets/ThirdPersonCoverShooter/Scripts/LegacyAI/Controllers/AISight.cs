...
namespace CoverShooter
{
    ...
    public class AISight : AIBase
    {
        ...
        private List<BaseActor> _visible = new List<BaseActor>();
        private List<BaseActor> _oldVisible = new List<BaseActor>();

        private HashSet<BaseActor> _visibleHash = new HashSet<BaseActor>();
        private HashSet<BaseActor> _oldVisibleHash = new HashSet<BaseActor>();
        private HashSet<BaseActor> _seenDeadHash = new HashSet<BaseActor>();

        private Dictionary<BaseActor, float> _lastSeenAlive = new Dictionary<BaseActor, float>();
        ...
        /// </summary>
        public void DoubleCheck(BaseActor actor)
        {
        ...
        /// </summary>
        public bool IsInDarkness(BaseActor actor)
        {
            var viewDistance = _actor.GetViewDistance(Distance, _isAlerted);
        ...
        /// </summary>
        public bool CheckVisibility(BaseActor actor)
        {
            var viewDistance = _actor.GetViewDistance(Distance, _isAlerted);
