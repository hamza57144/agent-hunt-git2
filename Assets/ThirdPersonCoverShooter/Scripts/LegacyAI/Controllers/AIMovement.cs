...
namespace CoverShooter
{
    ...
    public class AIMovement : AIBase
    {
        ...
        private static Dictionary<BaseActor, AIMovement> _movements = new Dictionary<BaseActor, AIMovement>();
        ...
        private bool checkIncomingCollisions(Vector3 ownMovement, float speed)
        {
            ...
            {
                var otherAsBase = AIUtil.Actors[i];
                var other = otherAsBase as Actor;
