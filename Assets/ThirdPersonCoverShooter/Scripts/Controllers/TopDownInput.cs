    ...
    public class TopDownInput : MonoBehaviour, ICharacterController
    {
        ...
        protected virtual void UpdateMovement()
        {
            ...
            if (WalkByDefault)
            {
                ...
                if (!_isZoomDown && ControlFreak2.CF2Input.GetButton("Run"))
            ...
            else
            {
                ...
                {
                    _isSprinting = ControlFreak2.CF2Input.GetButton("Run");
        ...
        {
            if (ControlFreak2.CF2Input.GetButtonDown("Fire") && !EventSystem.current.IsPointerOverGameObject())
                _isFireDown = true;

            if (ControlFreak2.CF2Input.GetButtonUp("Fire"))
                _isFireDown = false;

            if (ControlFreak2.CF2Input.GetButtonDown("Zoom") && !EventSystem.current.IsPointerOverGameObject())
                _isZoomDown = true;
        ...
        protected virtual void UpdateTarget()
        {
            ...
            var mouse = ControlFreak2.CF2Input.mousePosition;
