...
namespace CoverShooter
{
    ...
    public class StrategyInput : MonoBehaviour
    {
        ...
        private void showOutline(ref CharacterOutline outline, BaseActor target, Color color)
        {
            if (outline != null)
        ...
        private void Update()
        {
            ...
            var isMouseDown = ControlFreak2.CF2Input.GetMouseButtonDown(0);
            ...
            if (targetActions)
            {
                ...
                else if (ControlFreak2.CF2Input.GetMouseButtonDown(1))
                    Target = null;
            }
            else
            {
