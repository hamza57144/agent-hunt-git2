...
namespace UnityTemplateProjects
{
    public class SimpleCameraController : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            {
                var mouseMovement = new Vector2(ControlFreak2.CF2Input.GetAxis("Mouse X"), ControlFreak2.CF2Input.GetAxis("Mouse Y") * (invertY ? 1 : -1));
            ...
            boost += ControlFreak2.CF2Input.mouseScrollDelta.y * 0.2f;
