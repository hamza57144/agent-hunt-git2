...
{
    [MenuItem("uGUI/Anchors to Centre %.")]
    static void AnchorsToCentre()
    {
        foreach (Transform transform in Selection.transforms)
        {
            ...
            Vector2 newAnchorsMin = new Vector2(t.anchorMin.x + (t.offsetMin.x + (t.offsetMax.x - t.offsetMin.x) / 2) / pt.rect.width, t.anchorMin.y + (t.offsetMin.y + (t.offsetMax.y - t.offsetMin.y) / 2) / pt.rect.height);
            Vector2 newAnchorsMax = new Vector2(t.anchorMax.x + (t.offsetMin.x + (t.offsetMax.x - t.offsetMin.x) / 2) / pt.rect.width, t.anchorMax.y + (t.offsetMin.y + (t.offsetMax.y - t.offsetMin.y) / 2) / pt.rect.height);
